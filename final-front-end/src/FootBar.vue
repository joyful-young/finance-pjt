  ...
  <footer>
    ...
    <div style="background-color:rgb(230, 230, 230); font-size: 13px; ">
      <div style="text-align:center;  margin-top:20px; color:grey">
        <div class= "abc" style="padding-top: 5px; padding-bottom: 2px;"> 3% </div>
        <div style="padding-bottom: 2px;">SSAFY 9기</div>
        <div class="name" style="width:12.5%; font-size: 15px;">Kim YoungWoo | Park JaeYoung </div>
